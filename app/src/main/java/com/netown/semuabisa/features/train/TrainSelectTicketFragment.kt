 ...
 * Use the [TrainSelectTicketFragment.newInstance] factory method to
...
class TrainSelectTicketFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TrainSelectTicketFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TrainSelectTicketFragment().apply {
